...
export default function OnlineBootcamp() {
    return (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6">
                            ...
                            <p className="text-lg text-muted-foreground max-w-md">
                                Program Online Bootcamp Intensive merupakan program dari Dilesin Academy dimana peserta dalam bentuk kelompok yang terdiri dari 2-5 orang. Kelas bersifat online sehingga bisa diikuti peserta dari mana saja.
                            </p>
