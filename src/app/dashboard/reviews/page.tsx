...
export default function ReviewsPage() {
  ...
  if (isLoading) {
    return (
      <>
        <PageHeader title="Ulasan Saya" description="Kelola ulasan kursus dan event Anda" />
        ...
        <Tabs defaultValue="courses" className="w-full">
          ...
          <TabsContent value="courses">
            {courseReviews.length === 0 ? (
              <div className="bg-white rounded-xl shadow-sm p-8 text-center">
                ...
                <h2 className="text-xl font-semibold mb-2">Belum ada ulasan kursus</h2>
                <p className="text-gray-500 mb-6">Anda belum memberikan ulasan untuk kursus apapun.</p>
                <Link href="/dashboard/courses">
                  <Button className="bg-[#5596DF] hover:bg-blue-600">Ke Kursus Saya</Button>
                </Link>
              </div>
            ) : (
          ...
          <TabsContent value="events">
            {eventReviews.length === 0 ? (
              <div className="bg-white rounded-xl shadow-sm p-8 text-center">
                <Star className="h-12 w-12 text-gray-300 mx-auto mb-4" />
                <h2 className="text-xl font-semibold mb-2">Belum ada ulasan event</h2>
                <p className="text-gray-500 mb-6">Anda belum memberikan ulasan untuk event apapun.</p>
                <Link href="/dashboard/event">
                  <Button className="bg-[#5596DF] hover:bg-blue-600">Ke Event Saya</Button>
                </Link>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
