                ...
                <TableRow key={mentor.id}>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          {mentor.gender === "male" ? "Laki-laki" : mentor.gender === "female" ? "Perempuan" : "-"}
                        </p>
                      </div>
                    </div>
                  </TableCell>
                  ...
                  <TableCell>
                    <div className="flex space-x-2">
                      ...
                      <Button variant="destructive" size="icon" onClick={() => openDeleteDialog(mentor)}>
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Apakah Anda yakin ingin menghapus mentor &quot;{mentorToDelete?.name}&quot;? Tindakan ini tidak dapat
              dibatalkan.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
