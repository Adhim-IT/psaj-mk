        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  {...register("price")}
                  className="mt-1.5"
                  placeholder="Enter price (leave empty for free events)"
                />
              ...
              <div>
                ...
                {errors.whatsapp_group_link && (
                  <p className="mt-1 text-sm text-red-500">{errors.whatsapp_group_link.message}</p>
                )}
              </div>
          ...
          <div className="flex items-center gap-4 pt-4 border-t">
            <Button
              type="button"
              variant="outline"
              onClick={() => router.push("/admin/dashboard/event/list")}
              className="px-6"
            >
              Cancel
            </Button>
